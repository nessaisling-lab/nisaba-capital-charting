...
**Current version:** v13.0 "Polish & Performance" (shipped 2026-05-06; v13.1 fixes in flight)
**Next milestones:**
- **v13.1 "Polish corrections"** (in flight 2026-05-06) — Fix v13.0 regressions per video v96: revert forecast color (red), fix Lifecycle washed-out text, revert scrollbar gutter + investigate root cause, bell mockup for user pick, restore inline shooting star fetch animation.
